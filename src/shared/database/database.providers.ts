...
import { Projects, FigmaScreens, Result, Build, Screenshot, ModelResult, User } from '../entity/index.js';
...
export const databaseProviders = [
  {
    ...
    useFactory: async () => {
      ...
      sequelize.addModels([Projects, FigmaScreens, Result, Build, Screenshot, ModelResult, User]);
      try {
